...
(function() {
  ...
  function injectConsentStyle() {
    ...
    s.textContent =
      ...
      "#b77-consent .b77-consent-inner{pointer-events:auto;background:#FFFFFF;border:1px solid #0F0F0F;border-radius:2px;max-width:700px;width:100%;padding:26px 28px;display:flex;gap:28px;align-items:center;flex-wrap:wrap;font-family:'Hanken Grotesk',system-ui,sans-serif;}" +
      "#b77-consent .b77-consent-inner::before{content:'';position:absolute;}" +
      "#b77-consent .b77-consent-text{flex:1;min-width:240px;font-size:14.5px;line-height:1.6;color:#333333;}" +
      "#b77-consent .b77-consent-text strong{display:block;font-family:'Hanken Grotesk',sans-serif;font-weight:800;font-size:17px;color:#0F0F0F;margin-bottom:7px;letter-spacing:-.01em;}" +
      "#b77-consent .b77-consent-text strong::before{content:'';display:inline-block;width:18px;height:4px;background:#0F0F0F;vertical-align:middle;margin-right:10px;}" +
      "#b77-consent a{color:#0F0F0F;text-decoration:underline;text-underline-offset:2px;font-weight:700;}" +
      "#b77-consent .b77-consent-buttons{display:flex;gap:12px;flex-shrink:0;}" +
      "#b77-consent .b77-btn{font-family:'JetBrains Mono',ui-monospace,monospace;font-size:12px;letter-spacing:.06em;text-transform:uppercase;font-weight:600;padding:13px 22px;border-radius:2px;cursor:pointer;border:1px solid #0F0F0F;transition:background .2s,color .2s;white-space:nowrap;}" +
      "#b77-consent .b77-btn.primary{background:#0F0F0F;border-color:#0F0F0F;color:#FFFFFF;}" +
      "#b77-consent .b77-btn.primary:hover{background:#FFFFFF;color:#0F0F0F;}" +
      "#b77-consent .b77-btn.secondary{background:transparent;border-color:#0F0F0F;color:#0F0F0F;}" +
      "#b77-consent .b77-btn.secondary:hover{background:#0F0F0F;color:#FFFFFF;}" +
